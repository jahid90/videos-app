...
const createHandlers = ({ actions, queries }) => {
    const handleUsersIndex = (req, res) => {
        return queries
            .usersIndex()
            .then((users) =>
                res.render('apps/admin/templates/users-index', { users })
            );
    };
    ...
    const handleShowUser = (req, res) => {
        ...
        return Promise.all([
            ...
            return res.render('apps/admin/templates/user', {
                user,
                loginEvents,
                viewingEvents,
                creatorEvents,
        ...
        return queries
            ...
            .then((messages) =>
                renderPaginatedMessages(
                    ...
                    res,
                    messages,
                    'apps/admin/templates/messages-index'
                )
            );
    };
    ...
    const handleShowMessage = (req, res) => {
        ...
        return queries
            ...
            .then((message) =>
                res.render('apps/admin/templates/message', { message })
            );
    };
    ...
    const handleVideosIndex = (req, res) => {
        return queries
            .videos()
            .then((videos) =>
                res.render('apps/admin/templates/videos-index', { videos })
            );
    };
    ...
    const handleShowVideo = (req, res) => {
        ...
        return queries
            .video(videoId)
            .then((video) =>
                res.render('apps/admin/templates/video', { video, videoId })
            );
    };
    ...
    const handleStreamsIndex = (req, res) => {
        return queries
            .streams()
            .then((streams) =>
                res.render('apps/admin/templates/streams-index', { streams })
            );
    };

    const handleSubscriberPositions = (req, res) => {
        return queries.subscriberPositions().then((positions) =>
            res.render('apps/admin/templates/subscriber-positions', {
                positions,
            })
        );
    };
    ...
    const handleCategoriesIndex = (req, res) => {
        return queries
            .categories()
            .then((categories) =>
                res.render('apps/admin/templates/categories-index', {
                    categories,
                })
            );
    };
    ...
    const handleViewsIndex = (req, res) => {
        return queries.views().then((views) => {
            return res.render('apps/admin/templates/views-index', { views });
        });
    };
    ...
    const handleEntitiesIndex = (req, res) => {
        return queries.entities().then((entities) => {
            return res.render('apps/admin/templates/entities-index', {
                entities,
            });
        });
    };
    ...
    const handleShowEventTypes = (req, res) => {
        return queries
            .eventTypes()
            .then((eventTypes) =>
                res.render('apps/admin/templates/event-types', { eventTypes })
            );
    };
